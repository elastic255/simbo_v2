...
#ifndef __INET_BotnetPing_H
#define __INET_BotnetPing_H
 ...
 */
class INET_API BotnetPing : public cSimpleModule, public ILifecycle
{
  public:       //protect
  ...
  public:     //protect
    ...
    std::vector<L3Address> enderecos;
    virtual void adicionaEndereco(L3Address src);
    virtual bool pingFinalizado();
    virtual std::vector<L3Address> carregaEnderecos();
